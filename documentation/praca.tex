...
\author{
    \begin{tabular}{ll}
        Konrad Fugiel (134909) & Oliwier Hędrzak (134913) \\[0.1cm]
        \multicolumn{2}{c}{Filip Lisowski (134942)}
    \end{tabular}
}
\noAlbum{ }
...
\titlePL{Implementacja algorytmów sztucznej inteligencji na przykładzie gier Nim i Reversi – dokumentacja projektowa}
\titleEN{Implementation of artificial intelligence algorithms on the example of Nim and Reversi games – design documentation}

\shorttitlePL{Implementacja algorytmów sztucznej inteligencji w grach} 
\shorttitleEN{Implementation of artificial intelligence algorithms in games}
